...
import { Eye, Edit, ChevronLeft, ChevronRight, Check } from "lucide-react";
import {
  Table,
  TableBody,
  TableCell,
            ...
            <TableBody>
              {journals.map((journal) => (
                <TableRow
                  ...
                  onClick={() =>
                    window.open(`/siwake/${journal.journalNumber}`, "_blank")
                  }
                >
                  ...
                  <TableCell>{renderUserInfo(journal.createdUser)}</TableCell>
                  <TableCell>
                        ...
                        <AlertDialog>
                          ...
                          <AlertDialogContent>
                            ...
                            <AlertDialogFooter>
                              ...
                              <AlertDialogAction
                                onClick={() =>
                                  handleApproval(journal.journalNumber)
                                }
                                disabled={isApproving === journal.journalNumber}
                              >
                                {isApproving === journal.journalNumber
                                  ? "処理中..."
                                  : "はい"}
                              </AlertDialogAction>
                            </AlertDialogFooter>
