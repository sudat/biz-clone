...
import { DepartmentMasterList } from "@/components/accounting/department-master-list";
    ...
    <main className="space-y-4">
        ...
        <Card className="shadow-xl border-0 bg-card/60 backdrop-blur-sm overflow-hidden gap-0">
          <CardHeader className="bg-gradient-to-r from-muted/20 to-muted/10">
            <CardTitle className="text-2xl font-bold">部門一覧</CardTitle>
            <CardDescription className="text-base">
              登録されている計上部門の一覧です。クリックして編集できます。
            </CardDescription>
          </CardHeader>
          <CardContent className="p-8">
            ...
            >
              <DepartmentMasterList key={refreshTrigger} />
            </Suspense>
          </CardContent>
        </Card>
