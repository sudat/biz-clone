...
import { TaxRateMasterList } from "@/components/accounting/tax-rate-master-list";
    ...
    <main className="space-y-4">
        ...
        <Card className="shadow-xl border-0 bg-card/60 backdrop-blur-sm overflow-hidden gap-0">
          <CardHeader className="bg-gradient-to-r from-muted/20 to-muted/10">
            <CardTitle className="text-2xl font-bold">税区分一覧</CardTitle>
            <CardDescription className="text-base">
              登録されている税区分の一覧です。クリックして編集できます。
            </CardDescription>
          </CardHeader>
          <CardContent className="p-8">
            ...
            >
              <TaxRateMasterList key={refreshTrigger} />
            </Suspense>
          </CardContent>
        </Card>
